...
> - It is not POSIX, but it works under ksh93u+m, BASH and shells which support extended POSIX. If you know how to fix that, how to make it suck less, I'd be grateful if you'd make an issue or a PR.
---
